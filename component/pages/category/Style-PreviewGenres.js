...
export const ImageLargeStyle = { height: "100%", borderRadius: "10px", }
export const ImageSmStyle = { height: "100%", width: "100%", borderRadius: "10px", }
export const TitleInSm = { marginTop: "2rem" }
export const TrendingTitle = { mb: "7px" }