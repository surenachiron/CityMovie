...
const PlayTrailer = ({ image, id }) => {
    ...
    const handleOpen = async () => {
        ...
        if ((trailer.length === 0 || trailer === undefined) || router.query.length === undefined) {
            ...
            await fetch(`/api/movie-trailer/${originalId}`, configuration)
    ...
    return (
        <Box>
            ...
            <Button variant="text" color="inherit" onClick={handleOpen} sx={classes.buttonTrailer} >
                ...
                >
                    <Box sx={classes.boxSubParent}>
                        <Box sx={classes.boxHeaderTrailer}>
                            ...
                            <Button variant="text" color="inherit" sx={classes.buttonClose} onClick={handleClose}>
